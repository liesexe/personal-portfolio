        ...
        <div className="space-y-8">
            ...
            <div className="relative">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 p-1">
                <div className="w-full h-full rounded-full bg-white dark:bg-gray-800 flex items-center justify-center">
                  <span className="text-4xl md:text-6xl font-bold text-gray-700 dark:text-gray-300">
                    👨‍💻
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-4">
            <h1 className="text-4xl md:text-6xl font-bold text-gray-900 dark:text-white">
              {t('hero.greeting')} <span className="text-blue-600 dark:text-blue-400">Fernando Perez</span>
            </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="#contact"
              className="inline-flex items-center px-8 py-3 border-2 border-blue-600 text-blue-600 dark:text-blue-400 hover:bg-blue-600 hover:text-white font-semibold rounded-lg transition-colors duration-200"
            >
              {t('hero.contact')}
            </a>
          </div>
